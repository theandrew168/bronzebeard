...
def test_csrrw(rd, rs1, csr, code):
    assert asm.CSRRW(rd, rs1, csr) == code
...
def test_csrrs(rd, rs1, csr, code):
    assert asm.CSRRS(rd, rs1, csr) == code
...
def test_csrrc(rd, rs1, csr, code):
    assert asm.CSRRC(rd, rs1, csr) == code
...
def test_csrrwi(rd, uimm, csr, code):
    assert asm.CSRRWI(rd, uimm, csr) == code
...
def test_csrrsi(rd, uimm, csr, code):
    assert asm.CSRRSI(rd, uimm, csr) == code
...
def test_csrrci(rd, uimm, csr, code):
    assert asm.CSRRCI(rd, uimm, csr) == code
